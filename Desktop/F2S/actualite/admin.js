...
// Actualités - Chargement depuis localStorage
let actualites = [];

// Charger les actualités
function loadActualites() {
    const stored = localStorage.getItem('md_tech_actualites');
    if (stored) {
        actualites = JSON.parse(stored);
    } else {
        ...
        localStorage.setItem('md_tech_actualites', JSON.stringify(actualites));
    }
}
